...
const Feedbacks = () => {
  ...
  const handleOpenModal = () => {
    ...
    // Faire défiler jusqu'au titre "Témoignages"
    const testimonialsTitle = document.getElementById("temoignages");
    if (testimonialsTitle) {
      testimonialsTitle.scrollIntoView({
        behavior: "smooth", // Ajoute une animation de défilement
        block: "start", // Fait en sorte que le titre soit aligné en haut de la fenêtre de visualisation
      });
    }
  };
    ...
    <div className={`mt-12 bg-black-100 rounded-[20px]`}>
      ...
      >
        <motion.div variants={textVariant()}>
          ...
          <h2 className={styles.sectionHeadText} id="temoignages">
            Témoignages.
          </h2>
        </motion.div>
      </div>
      ...
      {modalOpen && (
        <div className="fixed inset-0 bottom-0 flex justify-center items-center bg-black bg-opacity-75 z-50">
